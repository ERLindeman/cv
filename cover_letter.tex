...
% Conditionally remove Photo and Margin Notes based on flags
\ifincludephoto
  % Include photo if needed (assuming you have a similar \photo command in the cover letter)
  \photo{2.5cm}{Enoch}
\else
  % Redefine \photo to do nothing if photos are excluded
